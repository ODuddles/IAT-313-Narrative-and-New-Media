...
# Helper function to handle portrait
func handle_portrait(character_name: String) -> void:
	var portrait = $Balloon/Portrait
	for child in portrait.get_children():
		child.queue_free()
	if character_name == "Boxy":
		var boxy_sprite_instance = boxy_sprite.instantiate()
		portrait.add_child(boxy_sprite_instance)
...
func apply_dialogue_line() -> void:
	...
	handle_portrait(dialogue_line.character)
